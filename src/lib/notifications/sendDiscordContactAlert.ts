...
const webhookMap: Record<SendDiscordContactAlertOptions['category'], string> = {
    general: ENVS.DISCORD_CONTACT_WEBHOOK, // General
    'bug report': ENVS.DISCORD_CONTACT_WEBHOOK, //ENVS.DISCORD_WEBHOOK_BUG_REPORT,
    'feature request': ENVS.DISCORD_CONTACT_WEBHOOK, //ENVS.DISCORD_WEBHOOK_FEATURE_REQUEST,
    support: ENVS.DISCORD_CONTACT_WEBHOOK, //ENVS.DISCORD_WEBHOOK_SUPPORT,
    feedback: ENVS.DISCORD_CONTACT_WEBHOOK, //ENVS.DISCORD_WEBHOOK_FEEDBACK,
    question: ENVS.DISCORD_CONTACT_WEBHOOK, //NVS.DISCORD_WEBHOOK_QUESTION,
    other: ENVS.DISCORD_CONTACT_WEBHOOK, //ENVS.DISCORD_WEBHOOK_OTHER,
};
