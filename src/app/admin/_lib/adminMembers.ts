import { experienceLevels, MEMBER_STATUSES, MemberData } from "@/lib/types/custom"
import {
  ...
  export const searchParamsCache = createSearchParamsCache({
    ...
    last_login_after: parseAsString.withDefault(""),
    last_login_before: parseAsString.withDefault(""),
    status: parseAsStringEnum([...MEMBER_STATUSES]).withDefault("active"),
    // advanced filter
